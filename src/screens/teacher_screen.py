        ...
        if st.button('Run Face Analysis', width='stretch', type='secondary', icon=':material/analytics:', disabled= not has_photos):
            with st.spinner('Deep scanning classroom photos...'):
                ...
                for idx, img in enumerate(st.session_state.attendance_images):
                    ...
                    detected, faces, embeddings = predict_attendance(img_np)
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter Username", placeholder='@abusayed')
    ...
    with btnc1:
        if st.button('Login',icon=':material/passkey:',shortcut='control+enter', width='stretch'):
            if login_teacher(teacher_username, teacher_pass):
                ...
                st.error("Invalid username and paasword combo")
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter Name", placeholder='Abu Sayed')
